...
class MicrobizBusinessResource extends BaseResource
{
    ...
    protected static ?string $modelLabel = 'Business Subcategory';

    protected static ?string $pluralModelLabel = 'Business Subcategories';
    ...
    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()
            ->whereHas('category', fn (Builder $q) => $q->where('domain', 'microbiz'));
    }
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\Section::make('Business Subcategory Details')
                    ->schema([
                        Forms\Components\Grid::make(2)
                            ->schema([
                                Forms\Components\Select::make('microbiz_category_id')
                                    ...
                                    ->options(function () {
                                        return MicrobizCategory::microbiz()->get()
                        ...
                        Forms\Components\FileUpload::make('image_url')
                            ...
                            ->image()
                            ->directory('microbiz-businesses')
                            ->columnSpanFull()
                            ->helperText('Upload an image for this business (shown on frontend)'),
                    ]),
                        ...
                        Forms\Components\Repeater::make('items')
                            ...
                            ->schema([
                                ...
                                Forms\Components\Textarea::make('specification')
                                    ->label('Specification')
                                    ->rows(2)
                                    ->placeholder('Brand, size, capacity, material, etc.')
                                    ->helperText('e.g., 5L plastic drinker, red color'),
        ...
        return $table
            ...
            ->filters([
                Tables\Filters\SelectFilter::make('microbiz_category_id')
                    ->label('Category')
                    ->options(function () {
                        return MicrobizCategory::microbiz()->pluck('name', 'id');
                    }),

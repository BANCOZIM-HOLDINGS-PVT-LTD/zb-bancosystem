...
export default function VerifyLoginOtp({ phone, maskedPhone }: VerifyLoginOtpProps) {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        post(route('client.login.otp.verify'));
    };
    ...
    const handleResend = async () => {
        ...
        try {
            const response = await axios.post(route('client.login.otp.resend'));

...
<head>
    ...
    <title>Government Pensioner Loan Application Form</title>
    <style>
        @page {
            size: A4;
            margin: 15mm;
...
<!-- PAGE 1: PENSIONER LOAN APPLICATION AND CONTRACT FORM -->
<div class="page">
    <div class="header">
        <div class="logo-left">
    ...
    <div class="section-header">GOVERNMENT PENSIONER LOAN APPLICATION AND CONTRACT FORM</div>
    ...
    <div class="section-header">2. NEXT OF KIN DETAILS</div>
    ...
    <div class="section-header">3. BANKING DETAILS</div>
    ...
    <div class="section-header">4. EXISTING LOANS</div>
    ...
    <div class="section-header">5. CREDIT APPLICATION DETAILS</div>
    ...
    <table>
        ...
        <tr>
            ...
            <td colspan="3"><span class="filled-field">{{ $getAny(['creditFacilityType', 'business', 'loanPurpose', 'purposeAsset']) }}</span></td>
        </tr>
    </table>
